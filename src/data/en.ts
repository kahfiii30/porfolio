...
work smarter?"`,
  ...
  projects: [
    {
      ...
      responsibilities: [
        ...
        "Product promotional creatives",
        "Instagram Story / Feed / Carousel content",
        "Promotional copywriting",
        "Campaign ideation",
        "Product information management",
        "Marketplace support",
        "Google Business / Maps content",
        "Inventory and branch data processing",
        "Promotional and leasing communication",
      ],
      context:
        "OG Store operates multiple gadget retail branches in Samarinda and handles fast-moving product promotions.\n\nThe challenge is not only creating content, but communicating changing prices, stock availability, branch information, credit options, and promotional urgency clearly.",
      challenges: [
        "high volume of product promotions",
        "changing product prices",
        "multi-branch information",
        "keeping brand visual consistency",
        "avoiding overly repetitive promotional content",
        "balancing urgency with readability",
      ],
      role: [
        "Creative execution",
        "Content planning",
    ...
    },
    {
      ...
      description:
        "Kahfi Audit Marketing is an independent project focused on helping small businesses understand problems across their digital customer journey.",
      areas: [
        "Google Maps",
        "Instagram",
        "Offer",
    ...
    },
    {
      ...
      shortDescription:
        "Personal finance web application concept designed to help users understand their financial position more clearly.",
      slug: "wealthpilot",
      ...
      note: "Personal product experiment / project.",
    ...
    },
    {
      ...
      shortDescription:
        "A personal creative service concept focused on helping individuals and small businesses improve their digital presence.",
      slug: "hitoshi-studio",
      areas: [
  ...
  experience: [
    ...
    },
    {
      ...
      highlight: "Selected as Favorite Staff #3 across 60 store branches.",
      responsibilities:
        "Product promotion, product explanation, customer interaction, merchandising, and product presentation.",
    },
    {
      ...
      responsibilities:
        "Customer service, high-pressure operations, and team collaboration.",
    },
  ],
  careerStory: {
    headline: "FROM SELLING\nPRODUCTS\nTO BUILDING\nDIGITAL SYSTEMS.",
    narrative: `My career did not begin in technology.

I started by working directly with customers.

That experience taught me how people ask,
hesitate, compare, decide, and buy.

Over time, my interests moved toward the systems
...
But I prefer learning by building.`,
  },
  lab: [
    {
      title: "01 — AI Automation",
      subtitle: "Building workflows that reduce repetitive work.",
      slug: "ai-automation",
    },
    {
      title: "02 — Digital Products",
      subtitle: "Turning ideas into usable digital tools.",
      slug: "digital-products",
    },
    {
      title: "03 — Marketing Systems",
      subtitle: "Connecting strategy, content, funnel and execution.",
      slug: "marketing-systems",
    },
    {
      title: "04 — Meta Ads & Performance",
      subtitle: "Campaign setup, creative testing and performance analysis.",
      slug: "meta-ads",
    },
    {
      title: "05 — Web Experiments",
  ...
  philosophy: {
    ...
    description:
      "AI is a tool.\nThe value still comes from understanding\nthe problem worth solving.",
  },
  principles: [
    {
      number: "01",
      ...
      description:
        "Do not create before understanding\nthe actual business problem.",
    },
    {
      number: "02",
      title: "MAKE IT CLEAR",
      description:
        "Good communication should reduce confusion,\nnot create more decoration.",
    },
    {
      number: "03",
      title: "BUILD & ITERATE",
      description:
        "Ideas become valuable after they are tested,\nobserved, and improved.",
    },
  ],
  contact: {
